...
const BaseEndpoint = process.env.NEXT_PUBLIC_BASE_ENDPOINT_DDD;

function useFetchDdd(appRoute, requestBody, method = "GET", immediateCall = false, callBack) {
